...
class ProceduralFutureScreen extends ConsumerStatefulWidget {
  ...
  @override
  _ProceduralFutureScreenState createState() => _ProceduralFutureScreenState();
}

class _ProceduralFutureScreenState
    extends ConsumerState<ProceduralFutureScreen> {
  int _timeElapsed = 0;
  Timer? _timer;
