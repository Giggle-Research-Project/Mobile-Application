...
import 'package:giggle/features/function%2004/verbal_future_activity_screen.dart';
import 'package:giggle/features/lessons/question_generate.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'dart:ui';

class QuestionSelectionScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuestionSelectionScreen> createState() =>
      _QuestionSelectionScreenState();
}

class _QuestionSelectionScreenState
    extends ConsumerState<QuestionSelectionScreen>
              ...
              : () {
                  if (widget.dyscalculiaType == 'Semantic Dyscalculia') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SemanticFutureScreen(
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => VerbalFutureScreen(
                          courseName: widget.courseName,
                          questions: [question],
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ProceduralFutureScreen(
                          courseName: widget.courseName,
                          questions: [question],
                          dyscalculiaType: widget.dyscalculiaType,
                          index: index.toString(),
